...
struct CStartupSettings
{
	...
	DECLARE_BASE(CStartupSettings, CNullType)			
...
struct CExportSettings
{
	...
	DECLARE_BASE(CExportSettings, CNullType)			
	static const uint32 LocalTypeFlags = TYPE_None; 
		const CTypeInfo* GetTypeinfo() const	
	{										
		return StaticGetTypeinfo();			
...
struct CSavePackagesSettings
{
	...
	DECLARE_BASE(CSavePackagesSettings, CNullType)
	static const uint32 LocalTypeFlags = TYPE_None; 
		const CTypeInfo* GetTypeinfo() const	
	{										
		return StaticGetTypeinfo();			
...
struct CUmodelSettings
{
	...
	DECLARE_BASE(CUmodelSettings, CNullType)			
	static const uint32 LocalTypeFlags = TYPE_None; 
		const CTypeInfo* GetTypeinfo() const	
	{										
		return StaticGetTypeinfo();			
